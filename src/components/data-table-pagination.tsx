...
export function DataTablePagination<TData>({
	table,
	onCurrentPageSizeChanged,
	onCurrentPageChanged,
}: DataTablePaginationProps<TData>) {
	const handleSetPageIndex = (index: number) => {
		table.setPageIndex(index);
		onCurrentPageChanged?.(index + 1); // Convert from 0-based to 1-based
	};
	return (
			...
			<div className="flex items-center space-x-6 lg:space-x-8">
				<div className="flex items-center space-x-2">
					...
					<Select
						...
						onValueChange={(value) => {
							...
							onCurrentPageSizeChanged?.(Number(value));
						}}
					>
				...
				<div className="flex items-center space-x-2">
					...
					<Button
						...
						onClick={() => handleSetPageIndex(table.getState().pagination.pageIndex - 1)}
						disabled={!table.getCanPreviousPage()}
					>
